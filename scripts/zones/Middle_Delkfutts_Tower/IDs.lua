...
zones[xi.zone.MIDDLE_DELKFUTTS_TOWER] =
{
    text =
    {
        ...
        ITEM_CANNOT_BE_OBTAINED       = 6549, -- You cannot obtain the <item>. Come back after sorting your inventory.
        ...
        LOGIN_CAMPAIGN_UNDERWAY       = 7169, -- The [/January/February/March/April/May/June/July/August/September/October/November/December] <number> Login Campaign is currently underway!
        ...
        MEMBERS_LEVELS_ARE_RESTRICTED = 7190, -- Your party is unable to participate because certain members' levels are restricted.
        FISHING_MESSAGE_OFFSET        = 7235, -- You can't fish here.
        CHEST_UNLOCKED                = 7344, -- You unlock the chest!
        SENSE_A_FOUL_PRESENCE         = 7353, -- You sense a foul presence.
        PLAYER_OBTAINS_ITEM           = 7392, -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 7393, -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 7394, -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 7395, -- You already possess that temporary item.
        NO_COMBINATION                = 7400, -- You were unable to enter a combination.
