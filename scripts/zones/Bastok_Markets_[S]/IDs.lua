...
zones[xi.zone.BASTOK_MARKETS_S] =
{
    text =
    {
        ...
        ITEM_RETURNED_TO_CHAR         = 6406,  -- The <keyitem> is returned to you.
        ...
        BLINGBRIX_SHOP_DIALOG         = 7223,  -- Blingbrix good Gobbie from Boodlix's! Boodlix's Emporium help fighting fighters and maging mages. Gil okay, okay?
        MOG_LOCKER_OFFSET             = 7489,  -- Your Mog Locker lease is valid until <timestamp>, kupo.
        REGIME_CANCELED               = 7727,  -- Current training regime canceled.
        HUNT_ACCEPTED                 = 7745,  -- Hunt accepted!
        USE_SCYLDS                    = 7746,  -- You use <number> [scyld/scylds]. Scyld balance: <number>.
        HUNT_RECORDED                 = 7757,  -- You record your hunt.
        OBTAIN_SCYLDS                 = 7759,  -- You obtain <number> [scyld/scylds]! Current balance: <number> [scyld/scylds].
        HUNT_CANCELED                 = 7763,  -- Hunt canceled.
        HOMEPOINT_SET                 = 10856, -- Home point set!
        KARLOTTE_DELIVERY_DIALOG      = 10890, -- I am here to help with all your parcel delivery needs.
        ...
        RETRIEVE_DIALOG_ID            = 14747, -- You retrieve <item> from the porter moogle's care.
        NOT_ENOUGH_NOTES              = 14772, -- You tryin' to cheat me? That's not nearly enough notes!
