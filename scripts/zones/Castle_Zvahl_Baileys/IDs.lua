...
zones[xi.zone.CASTLE_ZVAHL_BAILEYS] =
{
    text =
    {
        ...
        MOBLIN_EARPLUG_ON_THE_GROUND  = 7572, -- You see a Moblin earplug lying on the ground. Could Zeelozok have met his end here...?
        MARQUIS_ATTACKS               = 7573, -- Marquis Andrealphus and his minions attack!
        YOU_FIND_NOTHING              = 7574, -- You find nothing.
        BEGONE_FROM_THESE_HALLS       = 7575, -- Insolent adventurer! Begone from these halls!
