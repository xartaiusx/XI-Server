...
xi.quest.id =
{
    ...
    [xi.quest.area[xi.questLog.BASTOK]] =
    {
        ...
        RETURN_TO_THE_DEPTHS            = 78, -- + Converted
        ...
        ACHIEVING_TRUE_POWER            = 85, -- + Converted
        TOO_MANY_CHEFS                  = 86, -- +
        A_PROPER_BURIAL                 = 87,
    ...
    [xi.quest.area[xi.questLog.WINDURST]] =
    {
        ...
        WONDER_WANDS                    = 48, -- +
        HEAVEN_CENT                     = 49,
        SAY_IT_WITH_FLOWERS             = 50, -- + Converted
    ...
    [xi.quest.area[xi.questLog.JEUNO]] =
    {
        ...
        RUBBISH_DAY                     = 13, -- +
        NEVER_TO_RETURN                 = 14, -- +
        COMMUNITY_SERVICE               = 15, -- + Converted
        COOKS_PRIDE                     = 16, -- +
        ...
        FISTFUL_OF_FURY                 = 41, -- +
        THE_GOBLIN_TAILOR               = 42, -- + Converted
        PRETTY_LITTLE_THINGS            = 43, -- + Converted
        BORGHERTZS_WARRING_HANDS        = 44, -- + Converted
        BORGHERTZS_STRIKING_HANDS       = 45, -- + Converted
        BORGHERTZS_HEALING_HANDS        = 46, -- + Converted
        BORGHERTZS_SORCEROUS_HANDS      = 47, -- + Converted
        BORGHERTZS_VERMILLION_HANDS     = 48, -- + Converted
        BORGHERTZS_SNEAKY_HANDS         = 49, -- + Converted
        BORGHERTZS_STALWART_HANDS       = 50, -- + Converted
        BORGHERTZS_SHADOWY_HANDS        = 51, -- + Converted
        BORGHERTZS_WILD_HANDS           = 52, -- + Converted
        BORGHERTZS_HARMONIOUS_HANDS     = 53, -- + Converted
        BORGHERTZS_CHASING_HANDS        = 54, -- + Converted
        BORGHERTZS_LOYAL_HANDS          = 55, -- + Converted
        BORGHERTZS_LURKING_HANDS        = 56, -- + Converted
        BORGHERTZS_DRAGON_HANDS         = 57, -- + Converted
        BORGHERTZS_CALLING_HANDS        = 58, -- + Converted
        AXE_THE_COMPETITION             = 59, -- + Converted
        WINGS_OF_GOLD                   = 60, -- + Converted
        SCATTERED_INTO_SHADOW           = 61, -- + Converted
        A_NEW_DAWN                      = 62, -- +
        PAINFUL_MEMORY                  = 63, -- + Converted
        THE_REQUIEM                     = 64, -- +
        ...
        UNLISTED_QUALITIES              = 77, -- + Converted
    ...
    [xi.quest.area[xi.questLog.AHT_URHGAN]] =
    {
        ...
        NAVIGATING_THE_UNFRIENDLY_SEAS   = 25, -- + Converted
        AGAINST_ALL_ODDS                 = 26, -- + Converted
    ...
    [xi.quest.area[xi.questLog.CRYSTAL_WAR]] =
    {
        ...
        BETTER_PART_OF_VALOR             = 12, -- + Converted
        FIRES_OF_DISCONTENT              = 13, -- + Converted
        ...
        THE_FUMBLING_FRIAR               = 22, -- + Converted
        ...
        QUELLING_THE_STORM               = 42, -- + Converted
        HONOR_UNDER_FIRE                 = 43, -- + Converted
        ...
        BENEATH_THE_MASK                 = 49, -- + Converted
        WHAT_PRICE_LOYALTY               = 50, -- + Converted
        ...
        SON_AND_FATHER                   = 57,
        THE_TRUTH_LIES_HID               = 58, -- + Converted
        BONDS_OF_MYTHRIL                 = 59, -- + Converted
    ...
    [xi.quest.area[xi.questLog.ABYSSEA]] =
    {
        ...
        DAWN_OF_DEATH                   = 162, -- + Converted
        A_GOLDSTRUCK_GIGAS              = 163, -- + Converted
        TO_PASTE_A_PEISTE               = 164, -- + Converted
        MEGADRILE_MENACE                = 165, -- + Converted
        THE_FORBIDDEN_FRONTIER          = 166, -- + Converted
        FIRST_CONTACT                   = 167, -- + Converted
        AN_OFFICER_AND_A_PIRATE         = 168, -- + Converted
        HEART_OF_MADNESS                = 169, -- + Converted
        TENUOUS_EXISTENCE               = 170, -- + Converted
        CHAMPIONS_OF_ABYSSEA            = 171, -- + Converted
        THE_BEAST_OF_BASTORE            = 172, -- + Converted
        A_DELECTABLE_DEMON              = 173, -- + Converted
        A_FLUTTERY_FIEND                = 174, -- + Converted
        SCARS_OF_ABYSSEA                = 175, -- + Converted
        A_BEAKED_BLUSTERER              = 176, -- + Converted
        A_MAN_EATING_MITE               = 177, -- + Converted
        AN_ULCEROUS_URAGNITE            = 178, -- + Converted
        HEROES_OF_ABYSSEA               = 179, -- + Converted
        A_SEA_DOGS_SUMMONS              = 180, -- + Converted
...
xi.quest.setMustZone = function(player, areaId, questId)
    player:setCharVar(getVarPrefix(areaId, questId) .. 'mustZone', player:getZoneID())
end
