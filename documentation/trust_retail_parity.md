...
- 2026-06-25 report snapshot: `C:\Users\xtyty\Documents\FFXI-Runtime\reports\trust-parity-audit-20260625-002935.md` shows 122 local Trust scripts, 24 explicit profiles, 98 generated audit profiles, 17 active Trusts in the latest combat log, no unresolved log names, `tank_assist` only on Amchuchu/August/Valaineral, and old pre-patch early-refresh rows to retest after the duration-aware C++ predicate rebuild.
