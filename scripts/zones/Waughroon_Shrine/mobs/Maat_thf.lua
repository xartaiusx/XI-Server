...
entity.onMobInitialize = function(mob)
    ...
    mob:addListener('ITEM_STOLEN', 'MAAT_ITEM_STOLEN', function(mobArg, player, itemId)
        mobArg:messageText(mobArg, ID.text.YOUVE_COME_A_LONG_WAY)
        xi.combat.behavior.disableAllActions(mobArg)
        player:disengage()
...
entity.onMobFight = function(mob, target)
    ...
    then
        ...
        mob:useMobAbility(xi.mobSkill.PERFECT_DODGE_MAAT)
        return
    end
...
entity.onMobWeaponSkill = function(mob, target, skill, action)
    ...
    if skillID == xi.mobSkill.PERFECT_DODGE_MAAT then
